...
class _LocationInfoPageState extends State<KiteupLocationPage> {
  ...
  void checkIsPlannedLocation(
      PlannedLocationNotifier _plannedLocationNotifier) {
    (_plannedLocationNotifier.plannedLocation?.locationName ==
            location?.locationName)
        ? (_plannedLocationNotifier.isVisible)
            ? setState(() {
                _plannedLocationNotifier.updateVisibility(false);
              })
            : null
        : (!_plannedLocationNotifier.isVisible)
            ? setState(() {
                _plannedLocationNotifier.updateVisibility(true);
              })
            : null;
  }
  ...
  Widget build(BuildContext context) {
    ...
    //     (_) => checkIsPlannedLocation(_plannedLocationNotifier));
                          ...
                          Container(
                            ...
                            child: Center(
                              ...
                              children: const [
                                ...
                                SizedBox(width: 20),
                                Text("Ryan Stanford will arrive at 14:00",
                                    style: TextStyle(color: Colors.white)),
                              ],
                            )),
                          ),
                            ...
                            child: Center(
                              ...
                              children: const [
                                Text("11:03 ",
                                    style: TextStyle(color: Colors.white)),
                                SizedBox(width: 20),
                                Text("Cassidy Muels will arrive at 14:00",
                                    style: TextStyle(color: Colors.white)),
                              ],
                            )),
                          ),
                            ...
                            child: Center(
                              ...
                              children: const [
                                Text("12:17 ",
                                    style: TextStyle(color: Colors.white)),
                                SizedBox(width: 20),
                                Text("Verny Seeker will arrive at 13:00",
                                    style: TextStyle(color: Colors.white)),
                              ],
                            )),
                          ),
                            ...
                            child: Center(
                              ...
                              children: const [
                                Text("12:52 ",
                                    style: TextStyle(color: Colors.white)),
                                SizedBox(width: 20),
                                Text("Alsof Maker will arrive at 13:15",
                                    style: TextStyle(color: Colors.white)),
                              ],
                            )),
                          ),
                    ...
                    onTap: () async {
                      ...
                      if (sessionData[0] != null &&
                        ...
                        var endDateTime = DateTime.now()
                            .add(Duration(seconds: sessionData[2]));
