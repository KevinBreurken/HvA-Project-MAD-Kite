...
const List<Location> allLocations = [
  ...
  Location(id: 2, locationName: 'Bloemendaal aan Zee', adres: 'Strand, 151 TS Bloemendaal', distance: 14, windSpeed: 8,windDirection: 45,temperature: 7,weatherType: WeatherType.sunny,windIconColor: "F09D0A"),
  Location(id: 3, locationName: 'Strand Wijk aan Zee', adres: 'Strand, 1901 NZ Bloemendaal', distance: 7, windSpeed: 1,windDirection: 185,temperature: 32,weatherType: WeatherType.cloudy,windIconColor: "DEDEDE"),
  Location(id: 4, locationName: 'Egmond aan Zee', adres: 'Strand, 1486 AZ Egmond', distance: 14, windSpeed: 4,windDirection: 310,temperature: 1,weatherType: WeatherType.cloudy,windIconColor: "3971FF"),
  Location(id: 5, locationName: 'Castricum aan Zee', adres: 'Strand, 1901 NZ Castricum', distance: 4, windSpeed: 12,windDirection: 90,temperature: 5,weatherType: WeatherType.sunny,windIconColor: "76E648"),
  Location(id: 6, locationName: 'Bloemendaal aan Zee', adres: 'Strand, 151 TS Bloemendaal', distance: 14, windSpeed: 8,windDirection: 45,temperature: 7,weatherType: WeatherType.cloudy,windIconColor: "F09D0A"),
  ...
  Location(id: 8, locationName: 'Egmond aan Zee', adres: 'Strand, 1486 AZ Egmond', distance: 14, windSpeed: 4,windDirection: 310,temperature: 1,weatherType: WeatherType.cloudy,windIconColor: "3971FF"),
  ...
  Location(id: 10, locationName: 'Bloemendaal aan Zee', adres: 'Strand, 151 TS Bloemendaal', distance: 14, windSpeed: 8,windDirection: 45,temperature: 7,weatherType: WeatherType.sunny,windIconColor: "F09D0A"),
  ...
  Location(id: 12, locationName: 'Egmond aan Zee', adres: 'Strand, 1486 AZ Egmond', distance: 14, windSpeed: 4,windDirection: 310,temperature: 1,weatherType: WeatherType.sunny,windIconColor: "3971FF"),
